...
function shuttle_customizer_theme_options( $wp_customize ) {
	...
	//Storms Edit:  Adding options for a fourth slide
	// Add Image Slide 4 - Info
	$wp_customize->add_setting(
		'shuttle_redux_variables[shuttle_homepage_sliderimage4_info]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new shuttle_customizer_customcontrol_raw(
			$wp_customize,
			'shuttle_homepage_sliderimage4_info',
			array(
				'label'           => __( 'Slide 4', 'shuttle' ),
				'section'         => 'shuttle_customizer_section_homepage',
				'settings'        => 'shuttle_redux_variables[shuttle_homepage_sliderimage4_info]',
				'active_callback' => 'shuttle_customizer_callback_active_global',
			)
		)
	);
	...
	$wp_customize->add_setting(
		'shuttle_redux_variables[shuttle_homepage_sliderimage4_image][url]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize,
			'shuttle_homepage_sliderimage4_image',
			array(
				'section'         => 'shuttle_customizer_section_homepage',
				'settings'        => 'shuttle_redux_variables[shuttle_homepage_sliderimage4_image][url]',
				'label'	          => '',
				'description'	  => __( 'Image', 'shuttle' ),
				'active_callback' => 'shuttle_customizer_callback_active_global',
			)
	...
	$wp_customize->add_setting(
		'shuttle_redux_variables[shuttle_homepage_sliderimage4_title]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		'shuttle_homepage_sliderimage4_title',
		array(
			'section'		  => 'shuttle_customizer_section_homepage',
			'settings'		  => 'shuttle_redux_variables[shuttle_homepage_sliderimage4_title]',
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => __( 'Title', 'shuttle' ),
			'active_callback' => 'shuttle_customizer_callback_active_global',
	...
	$wp_customize->add_setting(
		'shuttle_redux_variables[shuttle_homepage_sliderimage4_desc]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		'shuttle_homepage_sliderimage4_desc',
		array(
			'section'		  => 'shuttle_customizer_section_homepage',
			'settings'		  => 'shuttle_redux_variables[shuttle_homepage_sliderimage4_desc]',
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => __( 'Description', 'shuttle' ),
			'active_callback' => 'shuttle_customizer_callback_active_global',
	...
	$wp_customize->add_setting(
		'shuttle_redux_variables[shuttle_homepage_sliderimage4_link]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		'shuttle_homepage_sliderimage4_link',
		array(
			'section'		  => 'shuttle_customizer_section_homepage',
			'settings'		  => 'shuttle_redux_variables[shuttle_homepage_sliderimage4_link]',
			'type'			  => 'dropdown-pages',
			'label'			  => '',
			'description'	  => __( 'URL', 'shuttle' ),
			'active_callback' => 'shuttle_customizer_callback_active_global',
