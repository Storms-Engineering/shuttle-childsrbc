...
function shuttle_customizer_callback_active_global( $control ) {
	...
	if ( $shuttle_homepage_sliderswitch == 'option4' and
			( $control_id == 'shuttle_homepage_sliderimage1_info' or 
			  ...
			  $control_id == 'shuttle_homepage_sliderimage4_info' or 
			  $control_id == 'shuttle_homepage_sliderimage4_image' or 
			  $control_id == 'shuttle_homepage_sliderimage4_title' or 
			  $control_id == 'shuttle_homepage_sliderimage4_desc' or 
			  $control_id == 'shuttle_homepage_sliderimage4_link' or 
