jQuery( document ).ready( function() {
	...
	if( jQuery( 'body' ).hasClass( 'wp-customizer' ) ) {
		...
		//Storms Edit adding fourth slide:
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_image"]' ).css( 'display', '' );
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_title"]' ).css( 'display', '' );
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_desc"]' ).css( 'display', '' );
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_link"]' ).css( 'display', '' );
		...
		//Storms Edit: fourth slide
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_info"]' ).click(function(e){ 
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_image"]' ).fadeToggle(300);
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_title"]' ).fadeToggle(300);
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_desc"]' ).fadeToggle(300);
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage4_link"]' ).fadeToggle(300);
