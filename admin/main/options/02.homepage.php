 ...
 *Edited by Brayden Storms to add a fourth slide to the home slider
 */
...
//Storms Edit: Adding another slide
$shuttle_homepage_sliderimage4_info  = shuttle_var ( 'shuttle_homepage_sliderimage4_info' );
$shuttle_homepage_sliderimage4_image = shuttle_var ( 'shuttle_homepage_sliderimage4_image', 'url' );
$shuttle_homepage_sliderimage4_title = shuttle_var ( 'shuttle_homepage_sliderimage4_title' );
$shuttle_homepage_sliderimage4_desc  = shuttle_var ( 'shuttle_homepage_sliderimage4_desc' );
$shuttle_homepage_sliderimage4_link  = shuttle_var ( 'shuttle_homepage_sliderimage4_link' );
	...
	$slide4_image_url = $shuttle_homepage_sliderimage4_image;
	...
	$slide4_title = $shuttle_homepage_sliderimage4_title;
	...
	$slide4_desc = $shuttle_homepage_sliderimage4_desc;
	...
	if( ! empty( $shuttle_homepage_sliderimage4_link ) ) {
		$slide4_link = get_permalink( $shuttle_homepage_sliderimage4_link );
	}
	...
	shuffle($shuttle_homepage_sliderpage);
...
$slider_default          = NULL;
	...
	if ( is_front_page() ) {
		...
		if ( ( current_user_can( 'edit_theme_options' ) and empty( $shuttle_homepage_sliderswitch ) ) or $shuttle_homepage_sliderswitch == 'option1' ) {
			...
			if( empty( $shuttle_homepage_sliderimage1_image ) and empty( $shuttle_homepage_sliderimage2_image ) and empty( $shuttle_homepage_sliderimage3_image ) and empty( $shuttle_homepage_sliderimage4_image  )) {
...
$shuttle_homepage_section4_link  = shuttle_var ( 'shuttle_homepage_section4_link' );
	...
	//Storms Edit: Force 4 column layout
	/*if ( empty( $shuttle_homepage_section_image ) ) {
